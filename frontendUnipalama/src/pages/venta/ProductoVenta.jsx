...
const ProductoVenta = ({ producto, verVenta }) => {
  ...
  return (
    <div
      className={
        verVenta
          ? "block lg:flex article-details-shopping w-full  border rounded-lg bg-white overflow-hidden my-2 justify-between"
          : "flex w-full h-1/2 border rounded-lg bg-white overflow-hidden my-2 justify-between"
      }
    >
      <div className={verVenta ? "flex w-full" : "flex"}>
        <div className="w-36 flex items-center-img  px-2 py-2 ">
          <img
        ...
        >
          ...
          <p className="font-medium  text-base uppercase">
            unidades : <span className="font-normal ">{cantidad}</span>
          </p>
          <p className="font-medium  text-base uppercase">
      ...
      <button
        ...
        } bg-red-700 p-3 btn-deleted-aside uppercase text-white font-medium hover:bg-red-500`}
