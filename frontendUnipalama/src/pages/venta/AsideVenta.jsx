...
const AsideVenta = ({ verAside, setAsideVentas }) => {
  ...
  return (
    <div
      className={`${
        verAside
          ? " absolute aside-shoppingCart top-20 right-0 bg-slate-200 p-4 overflow-auto z-10 w-full mb-96 flex flex-col justify-between h-[37rem]"
          : "hidden"
      }`}
    >
      <div className="overflow-y-scroll mb-3">
        <div className="flex items-center">
          <h1 className="font-bold text-3xl uppercase text-center md:w-2/3 mx-auto">
           <span className="text-sky-700">Carrito de compras</span>
          </h1>
          <button
      ...
      <button
        type="button"
        className="flex btn-details-shoppingCart bg-sky-700 text-white rounded-lg uppercase font-medium hover:bg-sky-500 transition-colors w-full"
      >
        <Link 
          to="/venta" 
      ...
      <button
        type="button"
        className="flex btn-details-shoppingCart bg-sky-700 text-white rounded-lg uppercase font-medium hover:bg-sky-500 transition-colors w-full mt-2"
